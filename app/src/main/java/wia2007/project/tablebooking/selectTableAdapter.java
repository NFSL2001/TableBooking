...
public class selectTableAdapter extends RecyclerView.Adapter<selectTableAdapter.selectTableViewHolder> {
    ...
    private ItemClickListenerTable clickListener;

    selectTableAdapter(Context context, List<Table> tables, ItemClickListenerTable clickListener) {
    ...
    public static class selectTableViewHolder extends RecyclerView.ViewHolder {
        ...
        public selectTableViewHolder(@NonNull View itemView, ItemClickListenerTable clickListener) {
            super(itemView);
