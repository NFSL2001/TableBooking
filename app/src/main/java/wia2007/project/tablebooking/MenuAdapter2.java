...
public class MenuAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        ...
        else if (object instanceof MenuBaseData.MenuAddItemButton) return R.layout.individual_menu_add_item_button;
        else if (object instanceof MenuBaseData.MenuAddCategoryButton) return R.layout.individual_menu_add_category_button;
        else return 0;
    }
